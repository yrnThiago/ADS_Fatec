...
def donuts(n: int) -> str:
  return f"Número de donuts: {n if n < 10 else 'muitos'}"
...
def busca(frase: str, palavra: str) -> int:
  cont = 0
  for i in range(len(frase)):
    if frase[i] == palavra[0] and palavra[1] + palavra[2] == frase[i+1:i+3]:
        cont += 1
